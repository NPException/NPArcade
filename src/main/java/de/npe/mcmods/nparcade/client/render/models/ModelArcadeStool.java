...
public class ModelArcadeStool extends ModelBase {
	...
	public static final ResourceLocation texture = new ResourceLocation(Reference.MOD_IDENTIFIER + "textures/blocks/arcadeStool.png");
	...
	public ModelArcadeStool() {
		...
		this.seatBottom = new ModelRenderer(this, 33, 0);
